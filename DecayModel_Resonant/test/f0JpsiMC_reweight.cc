//Reweight the f0Jpsi MC using the ratio of the pipimodel with that amplitude and the full pipimodel amplitude.
#include "Event.h"
...
int main( int argc, char* argv[] ) {
  ...
  pipimodel.initialise("../config/Bs2f0Jpsi_from_2013_069.json");
  Decmodel.initialise("../config/DecFilef0.json");
