/*
 * Model for the lineshape using a relativistic BW with normalisation term
 * 
...
KPiResonanceBWNorm::KPiResonanceBWNorm( const double mean,
                                const double width,
                                const double mB,
                                const double mpsi,
                                const double mkaon,
...
KPiResonanceBWNorm::KPiResonanceBWNorm( const KPiResonanceBWNorm& other ) :
...
std::complex<double> KPiResonanceBWNorm::lineshape( const double m, const double pB, const double pR ) const {
  if ( forbidden( m ) ){
  ...
  return (numer/denom)*(mean_*width_);
}
